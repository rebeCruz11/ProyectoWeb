        ...
        <div>
            ...
            <section id="planes">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="plan-container">
                                <div class="plan-title">PLAN ELITE</div>
                                ...
                                <div class="plan-row">ELITE FITNESS App <span class="check-icon">✔</span></div>
                                <div class="plan-row">ELITE FITNESS Go <span class="check-icon">✔</span></div>
                                <div class="plan-row">Invita a entrenar un amigo 5 veces al mes <span class="check-icon">✔</span></div>
                                <div class="plan-row">Acceso al ELITE FITNESS Spa <span class="check-icon">✔</span></div>
                        ...
                        <div class="col-md-4">
                            <div class="plan-container">
                                ...
                                <div class="plan-row">Acceso a todas las áreas del gimnasio <span class="check-icon">✔</span></div>
                                <div class="plan-row">ELITE FITNESS App <span class="check-icon">✔</span></div>
                                <div class="plan-row">ELITE FITNESS Go <span class="x-icon">✘</span></div>
                                <div class="plan-row">Invita a entrenar un amigo 5 veces al mes <span class="x-icon">✘</span></div>
                                <div class="plan-row">Acceso al ELITE FITNESS Spa <span class="x-icon">✘</span></div>
                                <div class="plan-row">Sin cargo de cancelación <span class="check-icon">✔</span></div>
                        ...
                        <div class="col-md-4">
                            <div class="plan-container">
                                <div class="plan-title">PLAN lite</div>
                                <div class="plan-row">Área de peso libre, peso integrado, cardio y clases grupales <span class="check-icon">✔</span></div>
                                <div class="plan-row">Acceso a todas las áreas del gimnasio <span class="check-icon">✔</span></div>
                                <div class="plan-row">ELITE FITNESS App <span class="check-icon">✔</span></div>
                                <div class="plan-row">ELITE FITNESS Go <span class="x-icon">✘</span></div>
                    ...
                    <Link to="/login" style={{width: "90%", margin:"60px" }} class="btn btn-outline-light ">
